...
class VotingMethodFactory:
    ...
    def create_method(method_name, movies, ballots, num_winners=1):
        ...
        if method_name == 'schulze':
            ...
            return InstantRunoffMethod(movies, ballots, reorder=False, num_winners=num_winners)
        elif method_name == 'instant-reorder':
            return InstantRunoffMethod(movies, ballots, reorder=True, num_winners=num_winners)
        else:
